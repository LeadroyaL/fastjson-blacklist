    ...
    public static BlackInfo getData() {
        if (data == null) {
            ...
            data.known = new LinkedList<BlackInfo.BlockItem>() {{
                ...
                add(new BlackInfo.BlockItem(-7921218830998286408L, "org.osjava.sj."));
                add(new BlackInfo.BlockItem(-7768608037458185275L, "org.apache.log4j."));
                add(new BlackInfo.BlockItem(-6179589609550493385L, "org.logicalcobwebs."));
                ...
                add(new BlackInfo.BlockItem(-2753427844400776271L, "com.ibatis.sqlmap.engine.datasource"));
