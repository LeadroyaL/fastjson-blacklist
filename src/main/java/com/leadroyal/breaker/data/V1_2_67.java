    ...
    public static BlackInfo getData() {
        if (data == null) {
            ...
            data.known = new LinkedList<BlackInfo.BlockItem>() {{
                ...
                add(new BlackInfo.BlockItem(-5885964883385605994L, "com.taobao.eagleeye.wrapper.")); //0xae50da1fad60a096L
                ...
                add(new BlackInfo.BlockItem(5474268165959054640L, "org.apache.cocoon.")); //0x4bf881e49d37f530L
