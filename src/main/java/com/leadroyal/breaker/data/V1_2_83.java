    ...
    public static BlackInfo getData() {
        if (data == null) {
            ...
            data.known = new LinkedList<BlackInfo.BlockItem>() {{
                ...
                add(new BlackInfo.BlockItem(-8382625455832334425L, "org.mvel2.")); //0x8baaee8f9bf77fa7L
                add(new BlackInfo.BlockItem(-6088208984980396913L, "kotlin.reflect.")); //0xab82562f53e6e48fL
                add(new BlackInfo.BlockItem(-4733542790109620528L, "com.googlecode.aviator.")); //0xbe4f13e96a6796d0L
