    ...
    public static BlackInfo getData() {
        if (data == null) {
            ...
            data.unknown = new LinkedList<BlackInfo.BlockItem>() {{
                ...
                add(new BlackInfo.BlockItem(-26639035867733124L, "")); //0xffa15bf021f1e37cL
                add(new BlackInfo.BlockItem(1153291637701043748L, "")); //0x100150a253996624L
                add(new BlackInfo.BlockItem(1698504441317515818L, "")); //0x17924cca5227622aL
            }};
        }
        return data;
    }
